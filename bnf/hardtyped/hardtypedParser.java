...
public class hardtypedParser extends Parser {
	...
	private static final String[] _LITERAL_NAMES = {
		null, "';'", "'0'", "'('", "')'", "'{'", "'}'", "'else'", "'false'", "'fun'", 
		"'if'", "'iszero'", "'pred'", "'return'", "'succ'", "'then'", "'true'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"MULTICOMMENT_antlr_builtin", "IDENT", "WS", "ErrorToken"
	};
	...
	public static class Start_ProgramContext extends ParserRuleContext {
		public hardtyped.Absyn.Program result;
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof hardtypedParserListener ) ((hardtypedParserListener)listener).enterStart_Program(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof hardtypedParserListener ) ((hardtypedParserListener)listener).exitStart_Program(this);
		}
	}
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof hardtypedParserListener ) ((hardtypedParserListener)listener).enterProgram(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof hardtypedParserListener ) ((hardtypedParserListener)listener).exitProgram(this);
		}
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			((ProgramContext)_localctx).p_1_1 = listExpr();
			 ((ProgramContext)_localctx).result =  new hardtyped.Absyn.ProgramExprs(((ProgramContext)_localctx).p_1_1.result); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case Surrogate_id_SYMB_15:
				...
				match(Surrogate_id_SYMB_15);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.ConstTrue(); 
				}
				break;
			case Surrogate_id_SYMB_7:
				...
				match(Surrogate_id_SYMB_7);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.ConstFalse(); 
				}
				break;
			case Surrogate_id_SYMB_9:
				...
				((ExprContext)_localctx).p_3_6 = expr(9);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.If(((ExprContext)_localctx).p_3_2.result,((ExprContext)_localctx).p_3_4.result,((ExprContext)_localctx).p_3_6.result); 
				}
				break;
			case Surrogate_id_SYMB_1:
				...
				match(Surrogate_id_SYMB_1);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.ConstZero(); 
				}
				break;
			case Surrogate_id_SYMB_13:
				...
				((ExprContext)_localctx).p_5_2 = expr(7);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.Succ(((ExprContext)_localctx).p_5_2.result); 
				}
				break;
			case Surrogate_id_SYMB_11:
				...
				((ExprContext)_localctx).p_6_2 = expr(6);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.Pred(((ExprContext)_localctx).p_6_2.result); 
				}
				break;
			case Surrogate_id_SYMB_10:
				...
				((ExprContext)_localctx).p_7_2 = expr(5);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.IsZero(((ExprContext)_localctx).p_7_2.result); 
				}
				break;
			case IDENT:
				{
				...
				((ExprContext)_localctx).p_8_1 = match(IDENT);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.Var(((ExprContext)_localctx).p_8_1.getText()); 
				}
				break;
			case Surrogate_id_SYMB_8:
				...
				match(Surrogate_id_SYMB_5);
				 ((ExprContext)_localctx).result =  new hardtyped.Absyn.Abstraction(((ExprContext)_localctx).p_9_3.getText(),((ExprContext)_localctx).p_9_7.result); 
				}
				break;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ExprContext)_localctx).p_10_2 = expr(3);
					 ((ExprContext)_localctx).result =  new hardtyped.Absyn.Application(((ExprContext)_localctx).p_10_1.result,((ExprContext)_localctx).p_10_2.result); 
					}
					} 
				}
				setState(92);
